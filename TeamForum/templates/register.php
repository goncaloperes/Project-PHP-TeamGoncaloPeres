<?php include('includes/header.php'); ?>
    ...
    <form role="form" enctype="multipart/form-data" method="post" action="register.php">
        <div class="form-group">
            <label><b>Name*</b></label> <input type="text" class="form-control"
                                               name="name" placeholder="Enter Your Name">
        </div>
        <div class="form-group">
            <label><b>Email Address*</b></label> <input type="email" class="form-control"
                                                        name="email" placeholder="Enter Your Email Address">
        </div>
        <div class="form-group">
            <label><b>Choose Username*</b></label> <input type="text"
        ...
        <input name="register" type="submit" class="btn btn-default" value="Join Us" />
    </form>
